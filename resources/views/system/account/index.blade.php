...
<div class="page">
    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <button class="btn btn-lg btn-primary-gradient mb-3">Tambahkan Akun Baru</button>
                            ...
                            <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap w-100">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;
                                        <a href="account/delete?id={{$data->id}}" class="btn btn-danger btn-sm"><i class="mdi mdi-delete"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
