    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">Edit Data Usaha</h5>
                    <nav>
                    ...
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <div class="card-title">
                                Edit Data {{ $usaha->nama }} ({{ $usaha->nik }})
                            </div>
                        </div>
                        <div class="card-body">
                            <form method="post" action="./edit">
                                @csrf
                                <input name="id" style="display: none" value="{{ $usaha->id }}">
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">NIK <b style="color='red';">*</b></label>
                                        <input type="text" name="nik" class="form-control" id="form-text" placeholder="" value="{{ $usaha->nik }}">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Nama</label>
                                        <input type="text" name="nama" class="form-control" id="form-text" placeholder="" value="{{ $usaha->nama }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Email</label>
                                        <input name="email" class="form-control" id="form-text" placeholder="" value="{{ $usaha->email }}">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">No Telp</label>
                                        <input name="phone" type="number" class="form-control" id="form-text" placeholder="" value="{{ $usaha->phone }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mb-3">
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input name="pekerjaan" class="form-control" id="form-text" placeholder="" value="{{ $usaha->pekerjaan }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Tempat Lahir</label>
                                        <input name="tempat_lahir" class="form-control" id="form-text" placeholder="" value="{{ $usaha->tempat_lahir }}">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Tanggal Lahir</label>
                                        <input name="tanggal_lahir" type="date" class="form-control" id="form-text" placeholder="" value="{{ $usaha->tanggal_lahir }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Tanggal Lahir</label>
                                        <textarea name="alamat" class="form-control">{{ $usaha->alamat }}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">File</label>
                                        <input type="file" class="form-control" id="form-text" placeholder="" value="{{ $usaha->file }}">
                                    </div>
                                    <div class="col-6 mb-3">
